...
namespace ContosoUniversity.Data
{
    public class SchoolContext : DbContext
    {
        ...
        {
            // Configure all DateTime properties to use timestamp without time zone (PostgreSQL equivalent of datetime2)
            ...
            // Configure Department.Budget as numeric for PostgreSQL (was money in SQL Server)
            modelBuilder.Entity<Department>()
                .Property(d => d.Budget)
                .HasColumnType("numeric(18,2)");

            // Configure Department concurrency token using PostgreSQL xmin system column
            modelBuilder.Entity<Department>()
